...
namespace Aburrimiento.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(BaggdbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Proveedores != null ? 
                          ...
                          Problem("Entity set 'BaggdbContext.Proveedores'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Empresa,Telefono")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Empresa,Telefono")] Proveedore proveedore)
        {
            if (id != proveedore.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BaggdbContext.Proveedores'  is null.");
            }
            var proveedore = await _context.Proveedores.FindAsync(id);
            if (proveedore != null)
            {
